...
add_file -vhdl -lib "work" {F:/hghg/LCDram/lcdram00.vhdl}
add_file -vhdl -lib "work" {F:/hghg/LCDram/packagelcdram00.vhdl}
add_file -vhdl -lib "work" {F:/hghg/LCDram/toplcdram00.vhdl}

#-- top module name
set_option -top_module toplcdram00

#-- set result format/file last
project -result_file {F:/hghg/LCDram/LCDram/LCDram00_LCDram.edi}
